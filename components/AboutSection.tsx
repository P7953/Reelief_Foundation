          ...
          >
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p className="leading-relaxed">
                ...
                we work collaboratively with civil society, government bodies, philanthropic institutions, and corporate partners to create large-scale, sustainable impact.
              </p>
              <div className="bg-gradient-to-r from-primary-yellow/10 to-primary-orange/10 border-l-4 border-primary-orange p-5 rounded-r-lg my-6">
                <p className="font-bold text-gray-800 text-lg">
                  Our Mission: To Empower persons with disabilities across all aspects of life and enable them to live with dignity.
                </p>
              </div>
              <p className="leading-relaxed">
                We provide essential support to Persons with Disabilities (PWDs) through easy access to welfare scheme information, assistance with important documents, 
                updates on Divyang camps, insurance guidance, verified disability-related resources, and a centralized hub for schemes, GRs, and support services—ensuring 
                every individual receives the help they need with clarity and convenience.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                <div className="text-3xl font-bold text-primary-orange mb-1">5K+</div>
                <div className="text-sm text-gray-600">Beneficiaries</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                <div className="text-3xl font-bold text-primary-orange mb-1">10+</div>
                <div className="text-sm text-gray-600">Partners</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-xl">
                <div className="text-3xl font-bold text-primary-orange mb-1">50+</div>
